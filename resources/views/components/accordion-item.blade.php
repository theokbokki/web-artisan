<li
  class="group inline-block hover:bg-slate-100 focus:bg-slate-100 hover:my-1 p-5 focus:my-5 transition-all ease-in-out duration-300 rounded-md focus:space-y-2 min-w-full"
  {{ $attributes }}>
