<div>
  <input type="checkbox" name="search" id="search" class="sr-only peer">

  <label for="search" class="flex gap-x-2 relative w-full shrink items-center">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
      class="w-8 h-8 text-slate-400 absolute pl-3">
      <path stroke-linecap="round" stroke-linejoin="round"
        d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
    </svg>
    <span class="input block w-full pl-10">Chercher...</span>
  </label>
  <div class="fixed top-0 left-0 h-[100vh] w-[100vw] p-4 invisible peer-checked:visible z-10">
    <label for="search" class="fixed inset-0 bg-slate-900 backdrop-blur-sm bg-opacity-20">
    </label>
    <div
