<div class="inline-block w-full shrink">
  <input type="checkbox" name="forum-search" id="forum-search" class="sr-only peer">
  <label for="forum-search" class="flex gap-x-2 items-center input">
  ...
  <div class="fixed top-0 left-0 h-[100vh] w-[100vw] p-4 invisible peer-checked:visible z-10 md:grid">
    ...
    <div
      ...
      <form action="#" class="grid gap-4">
        <label for="search" class="label">Chercher dans notre forum</label>
        <p class="">{{ __('Chercher par tag, auteur, date, ...') }}</p>
