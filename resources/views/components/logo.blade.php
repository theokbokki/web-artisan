  <figure class="flex items-center">
    <svg xmlns="http://www.w3.org/2000/svg" width="53.852" height="27.68" viewBox="0 0 53.852 27.68">
      <path
    ...
    <figcaption class="text-[0]  text-indigo-600 font-title font-bold max-w-[5.5rem] leading-4 sm:text-[1rem]">
      {{ __('logo.tagline') }}
    </figcaption>
  </figure>
